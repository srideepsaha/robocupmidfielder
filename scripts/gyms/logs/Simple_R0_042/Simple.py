...
class Train(Train_Base):
    ...
    def train(self, args):
        ...
        # def init_env(i_env):
        #     def thunk():
        #         env = InterceptionEnv(self.ip, self.server_p + i_env, self.monitor_p_1000 + i_env, self.robot_type, False)
        #         return VecMonitor(env, filename=None)  # logs in memory, no file needed per env
        #     return thunk
        ...
        try:
            ...
            model_path = self.learn_model(
                ...
                eval_env=eval_env,
                eval_freq=n_steps_per_env * 2000,
...
# Train start:    12/08/2025 07:21:18
# Train end:      12/08/2025 07:33:52
# Train duration: 0:12:33