...
class InterceptionEnv(gym.Env):
    ...
    def step(self, action):
        ...
        #     done = True
        info = {
                    "robot_pos": w.robot.loc_head_position[:2].copy(),
                    "ball_pos":  w.ball_abs_pos[:2].copy()
                }
...
class Train(Train_Base):
    ...
    def test(self, args):
        ...
        try:
            ...
            self.test_model(model, env, log_path=args["folder_dir"], model_path=args["folder_dir"], max_episodes=5)
        except KeyboardInterrupt:
            print()
...
# Train start:    26/06/2025 07:31:55
# Train end:      26/06/2025 07:34:25
# Train duration: 0:02:29