...
player2 = Agent("localhost", 3100, 3200, 8, 1, "TeamName")
...
for _ in range(5):
    ...
    player2.scom.unofficial_beam((-3, -0.1, 0.5), 0)
    player2.behavior.execute("Zero")
    player2.scom.commit_and_send(w.robot.get_command())
    player.scom.receive()
